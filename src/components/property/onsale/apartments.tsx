...
const ApartmentsOnly = () => {
    ...
    const fetchApartments = async () => {
        setLoading(true);
        let filter = `&filters[propertyType][type][$eq]=Apartment&filters[$or][0][rental][$null]=true&filters[$or][1][rental][$eq]=false`;
    ...
    return (
        <Container mt={30} size="lg">
            <Text ta="center" fz={23} c={colors.secondaryColor} fw={500} ff={"'Patrick Hand', cursive"} mb={20}>Search Apartments on Sale</Text>
            <SearchBar />
